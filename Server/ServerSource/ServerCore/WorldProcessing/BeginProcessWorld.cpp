                                                                 ...
                                                                 GetMovementSpeed()))))
                                    {
                                        ...
                                        for (auto it =
                                            ...
                                            if (it->x == x && it->y == y) {
                                                ...
                                                auto beginningTile =
                                                    worldArea->GetTile(worldArea->m_roadPath.points[0]);
                                                
                                                beginningTile->SetCreature(creature);
                                                worldArea->GetTile(
                                                    x,
                                                    y)->SetCreature(nullptr);
                                                ...
                                                if (creature->GetConnectedObject()) {
                                                    ...
                                                    auto objectCoord = creature->GetConnectedObject()->objectCoord;
                                                    
                                                    auto objectTile = worldArea->GetTile(objectCoord);
                                                    ...
                                                    for (auto object : objectTile->GetObjectsPile().GetObjects()) {
                                                        ...
                                                        if (object == creature->GetConnectedObject()->connectedObject) {
                                                            ...
                                                            tile->GetObjectsPile().AddObject(std::shared_ptr<Object>(object));
