...
/// end an repeating image drawing instruction to the user.
/// @param userID User ID of user for which to draw.
/// @param imageName Hash code of image name to draw.
/// @param dest Destination to draw the image at.
/// @param textureFillAmount Scaling of the repeated texture pattern.
