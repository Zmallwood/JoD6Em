...
class GUITextConsole : public GUIPanel {
  ...
  private:
    ...
    static constexpr float k_width {0.35f};      ///< Width of the text console.
    
    static constexpr float k_height {0.2f};      ///< Height of the text console.
    
    static constexpr float k_lineHeight {0.02f}; ///< Line height in the text console.
    
    static constexpr float k_margin {0.005f};    ///< Margin inside the edges of the text console.
};
